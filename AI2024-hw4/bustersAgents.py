...
class GreedyBustersAgent(BustersAgent):
    ...
    #         ghostPosition = max(distribution, key=distribution.get)
    ...
    #         if bestAction is None or distance < closestDistance:
    #             closestDistance = distance
    #             bestAction = action

    #     return bestAction if bestAction else random.choice(legalActions)
